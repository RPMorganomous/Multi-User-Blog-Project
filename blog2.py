...
import webapp2
import jinja2
#import time # only need this if not using parent keys
...
def filterName(is_id): # used in permalink.html to convert user id to user name
    user_obj = User.by_id(is_id)
    if user_obj:
